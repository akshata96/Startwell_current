            ...
            <Header>
                <div className="logo" />
                    <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['1']}>
                        ...
                        <Menu.Item key="2" className="Menuitems" style={{float:"right"}}>About</Menu.Item>
                        <Menu.Item key="3" className="Menuitems" style={{float:"right"}}>Contact Us</Menu.Item>
                        <Menu.Item key="4" className="Menuitems" style={{float:"right"}}>Self Help</Menu.Item>
                        <Menu.Item key="5" className="Menuitems" style={{float:"right"}}>Home</Menu.Item>
